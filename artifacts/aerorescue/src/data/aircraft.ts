...
export const aircraftCatalog: Aircraft[] = [
  ...
  },
  {
    ...
    manuals: [
      { name: 'Manual de operações — H-60L Black Hawk (FAB)', meta: 'PDF · revisão operacional' },
      { name: 'Checklist de pré-voo — H-60L', meta: 'PDF · revisão local' },
      { name: 'Guia de missão de busca e salvamento', meta: 'PDF · revisão tática' },
    ],
  },
];
