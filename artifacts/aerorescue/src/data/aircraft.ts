...
export const aircraftCatalog: Aircraft[] = [
  ...
  },
  {
    ...
    videos: [
      { title: 'Abordagem com Acesso ao Piloto.mp4', url: 'https://drive.google.com/file/d/1l4rMFGGE7-mErrhs01LeBqqkLcENL5k_/view?usp=drive_link' },
  ...
  },
  {
    ...
    gallery: [
      { title: 'Galeria F-2000C', url: 'https://drive.google.com/uc?export=view&id=1WRPunDu6LTvmw-UzXsbliQbEfshR3PPA' },
    ],
    videos: [
  ...
  videos: [
    { title: 'Abertura Compartimento de Carga - EMB 120.AVI', url: 'https://drive.google.com/file/d/1NsxzgH-LEXLUYlzDdAI_IzIRoe6l04al/view?usp=drive_link' },
    { title: 'Abertura da Porta (Lateral Esquerda) - EMB 120.AVI', url: 'https://drive.google.com/file/d/1qMnvc204Oh_eP_KI3O1dZ4mIHjXFP8uG/view?usp=drive_link' },
    { title: 'Corte Combustível - EMB 120.AVI', url: 'https://drive.google.com/file/d/1Jq0Nl9mKDdYOfrN52a1EEMqFNqZETkfH/view?usp=drive_link' },
    ...
    { title: 'Retirada da Janela de Emergência (Pelo Interior) - EMB 120.AVI', url: 'https://drive.google.com/file/d/1AYBQaAH1t6l9CU4c6x_f731dZp7PL2nn/view?usp=drive_link' },
  ...
  },
  {
    ...
    procedures: [
      ...
      gallery: [
        { title: 'Galeria C-98 01', url: 'https://drive.google.com/uc?export=view&id=1VZSBWUk8oNsIeeaEHX5_IiM1Ibv0lC0B' },
        { title: 'Galeria C-98 02', url: 'https://drive.google.com/uc?export=view&id=1mtjnUv-YcdEqg-yUyZf0HbHbAvMCZP7N' },
        { title: 'Galeria C-98 03', url: 'https://drive.google.com/uc?export=view&id=1DPqKgR0kaoSjcAUUZvGC73GPuMykdWcc' },
        { title: 'Galeria C-98 04', url: 'https://drive.google.com/uc?export=view&id=1f_oKWap5FQ9Qia31TqsOxmCJgS4dysU-' },
        { title: 'Galeria C-98 05', url: 'https://drive.google.com/uc?export=view&id=1tiETdgxCkk9iuc9lFS08Ie-U9E9xk9mp' },
        { title: 'Galeria C-98 06', url: 'https://drive.google.com/uc?export=view&id=1QiWSwJSL-SMAj6XEH9fJ0BTnX5M7rXB7' },
        { title: 'Galeria C-98 07', url: 'https://drive.google.com/uc?export=view&id=1qxCcWEOas9S7OYlPjbQFz3zvSTl-492p' },
        { title: 'Galeria C-98 08', url: 'https://drive.google.com/uc?export=view&id=1kV7zLtIl7Y4NEEhsM3sHLjUdLGegWzVe' },
        { title: 'Galeria C-98 09', url: 'https://drive.google.com/uc?export=view&id=1UVwODu3V8bRIzVGGEvdHbF9Pma_bOOL8' },
        { title: 'Galeria C-98 10', url: 'https://drive.google.com/uc?export=view&id=1cwDbBxYKp6GHKG8GJ0ahEvRhgYwisVSV' },
        { title: 'Galeria C-98 11', url: 'https://drive.google.com/uc?export=view&id=1K-7JDY9_HUjDxq-LpibAIWhAuGNN62_2' },
        { title: 'Galeria C-98 12', url: 'https://drive.google.com/uc?export=view&id=1FPRz-1NbfFA5TVm_2LYUjIuBSt8ayWMJ' },
        { title: 'Galeria C-98 13', url: 'https://drive.google.com/uc?export=view&id=1gWp-mPclphc4U1v_jHvC0W7HaxJUm1Xm' },
        { title: 'Galeria C-98 14', url: 'https://drive.google.com/uc?export=view&id=1Syv2z35cYmpvTnPUR9DXBNCn1phbp5q6' },
        { title: 'Galeria C-98 15', url: 'https://drive.google.com/uc?export=view&id=18eq6HjiRpfFQzf3Vu_1l6LC4brVoQ1c9' },
        { title: 'Galeria C-98 16', url: 'https://drive.google.com/uc?export=view&id=1BcaVHYA7I_LYVLSQzmMHFAodrbHJCHRh' },
        { title: 'Galeria C-98 17', url: 'https://drive.google.com/uc?export=view&id=1kZMZJMjrJNPX3JTv5rBdjbCkyT3DBeES' },
        { title: 'Galeria C-98 18', url: 'https://drive.google.com/uc?export=view&id=1HLsAhUEn-beZDlhWF-B6XUXCxW5nnFes' },
        { title: 'Galeria C-98 19', url: 'https://drive.google.com/uc?export=view&id=1kFQ9QwhMc6SckGSnb536SukGtR1eXIdE' },
        { title: 'Galeria C-98 20', url: 'https://drive.google.com/uc?export=view&id=1EUpBZy4o5A2KK9Ce3NpiDbQVOLM8bB1r' },
        { title: 'Galeria C-98 21', url: 'https://drive.google.com/uc?export=view&id=1-dRrnUhJz1CgS1tA5w21_wmjaIdi3I_d' },
        { title: 'Galeria C-98 22', url: 'https://drive.google.com/uc?export=view&id=1R2gvSzfcZ2tCUIycqFIl7kUcbaeaH2OU' },
        { title: 'Galeria C-98 23', url: 'https://drive.google.com/uc?export=view&id=18GtvBK4_Akpo7TQFXgRnBE843qLgXsKf' },
        { title: 'Galeria C-98 24', url: 'https://drive.google.com/uc?export=view&id=1e5P3ryWVa9s0vrVMdCDejKe1mznavdh4' },
        { title: 'Galeria C-98 25', url: 'https://drive.google.com/uc?export=view&id=1CB0el5yd5XLK5ren7PR_89of2VfvF2t7' },
        { title: 'Galeria C-98 26', url: 'https://drive.google.com/uc?export=view&id=1I8yK1dYk32aLjIU_bw8IVkbXJkMSj_Pd' },
        { title: 'Galeria C-98 27', url: 'https://drive.google.com/uc?export=view&id=1FreQQ7O76iVh05AtG70d4LzX1HZJSoCJ' },
        { title: 'Galeria C-98 28', url: 'https://drive.google.com/uc?export=view&id=1mkx2qSmasBxfCALeEawJJV1OIhgBdVVW' },
        { title: 'Galeria C-98 29', url: 'https://drive.google.com/uc?export=view&id=1s2ZA78eLVH8AHyDoc51BW20NMWwRhyQl' },
        { title: 'Galeria C-98 30', url: 'https://drive.google.com/uc?export=view&id=1J7jQnG1EHyT8j9jeoag6o6NwuHCRsiVP' },
        { title: 'Galeria C-98 31', url: 'https://drive.google.com/uc?export=view&id=1EwqV9vPbfDbYSPPrdcy24qMvdWQiFEz9' },
  ...
  },
  {
    ...
    videos: [
      { title: 'Abertura de Porta Frontal E/R99.MOV', url: 'https://drive.google.com/file/d/1SsWbitMtMSbUScjpgV3XJapxzVGSqtNe/view?usp=drive_link' },
      { title: 'Fechamento de Porta Frontal E/R99.MOV', url: 'https://drive.google.com/file/d/1g5vpkP6d2cjdnfexMUsKemJDuiALBAVP/view?usp=drive_link' },
      ...
      { title: 'Cockpit ER 99.mp4', url: 'https://drive.google.com/file/d/1hrKRxogEH2GNygm1-yYDukVlKAl7Hax1/view?usp=drive_link' },
      { title: 'E/R99A (Área Externa).MOV', url: 'https://drive.google.com/file/d/1qQiervq-PPZwfq06_vQW6DxZPk-bB9N2/view?usp=drive_link' },
      { title: 'Área Externa E/R99A.MOV', url: 'https://drive.google.com/file/d/1RavXIld5hksz-Eh8nsOCs5QvMMfYrb8c/view?usp=drive_link' },
      { title: 'Abertura de Compartimento.MOV', url: 'https://drive.google.com/file/d/1c3peqqfugaKssgb-EnY2H6OJEeeTNQgt/view?usp=drive_link' },
  ...
  },
  {
    ...
    gallery: [
      ...
      { title: 'Galeria VH-35 02', url: 'https://drive.google.com/uc?export=view&id=1XmEIRolo9KxlhhOyWuJOx_ZGFQSqwYu6' },
      { title: 'Galeria VH-35 03', url: 'https://drive.google.com/uc?export=view&id=1fXTJXSlyIz81ErIPNS7rkU_bt5yv_ejs' },
      { title: 'Galeria VH-35 04', url: 'https://drive.google.com/uc?export=view&id=1l7s150lF03QrWHjBSNe8nXf2YhrJusHd' },
      { title: 'Galeria VH-35 05', url: 'https://drive.google.com/uc?export=view&id=1ew-dGkIvpAoVfAXqmnm1hc6BIMxDcXxE' },
      { title: 'Galeria VH-35 06', url: 'https://drive.google.com/uc?export=view&id=1RxSXrS0FmU3lY_0zEdWDnjDI7xrf0f_2' },
      { title: 'Galeria VH-35 07', url: 'https://drive.google.com/uc?export=view&id=1zXWaLjSPL73qxblyCuR5_6dwbnmMO-3N' },
      { title: 'Galeria VH-35 08', url: 'https://drive.google.com/uc?export=view&id=1ozxc5vC-udCZbqzIWU9J3sYtYnGPRRsg' },
      { title: 'Galeria VH-35 09', url: 'https://drive.google.com/uc?export=view&id=1uQ-Rewwt1eyIYuWy2z2VEK0wjPDf1nxM' },
      { title: 'Galeria VH-35 10', url: 'https://drive.google.com/uc?export=view&id=1Pv0uDc_cW-i9iip-uGTgkgJUGZsWFD_N' },
    ],
    videos: [
